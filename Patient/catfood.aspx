<%@ Page Title="" Language="C#" MasterPageFile="~/Patient/patientmaster.master" AutoEventWireup="true" CodeFile="catfood.aspx.cs" Inherits="Patient_catfood" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" cellpadding="2" cellspacing="10" class="style4">
        <tr>
            <td style="text-align: center; font-size: xx-large" class="style6">
                Cat Food</td>
        </tr>
        <tr>
            <td class="style5">
        ...
        <tr>
            <td class="style5">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Cat Food" Name="Product_Category" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
