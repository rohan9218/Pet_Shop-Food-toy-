<%@ Page Title="" Language="C#" MasterPageFile="~/Visitors/Visitormaster.master" AutoEventWireup="true" CodeFile="Fish Food.aspx.cs" Inherits="Visitors_Fish_Food" %>
        ...
        <tr>
            <td style="text-align: center">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Fish Food" Name="Product_Category" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    SelectCommand="SELECT * FROM [Product] WHERE ([Product Name] = @Product_Name)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="Fish Food" Name="Product_Name" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
