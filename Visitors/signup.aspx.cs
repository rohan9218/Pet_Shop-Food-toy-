...
public partial class Visitors_signup : System.Web.UI.Page
{
    ...
    protected void txtlogin_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        cmd.CommandText = " select Name,Password from Admin where Name='" + txtname.Text + "'and Password='" + txtpassword.Text + "'";
        cmd.Connection = cn;
        cmd.ExecuteNonQuery();
